...
PUBLIC	??_C@_0DA@BNIHJLDD@?6Hospital?5Reservation?5system?5in@ ; `string'
...
CONST	ENDS
;	COMDAT ??_C@_0DA@BNIHJLDD@?6Hospital?5Reservation?5system?5in@
CONST	SEGMENT
??_C@_0DA@BNIHJLDD@?6Hospital?5Reservation?5system?5in@ DB 0aH, 'Hospital'
	DB	' Reservation system initializing ...', 0aH, 0aH, 00H ; `string'
CONST	ENDS
...
text$x	ENDS
; Function compile flags: /Odtp /RTCsu /ZI
; File C:\Users\Holland\Desktop\Holland's Stuff\CSUFSchool\CPSC 462\Hospital-Reservation-System\Desktop_Presentation\SourceCode\main.cpp
;	COMDAT main
_TEXT	SEGMENT
userInterface$7 = 8
response$8 = 36
...
$LN24:
	...
	xor	rax, rbp
	mov	QWORD PTR __$ArrayPad$[rbp], rax
	lea	rcx, OFFSET FLAT:__EEA1013D_main@cpp
	call	__CheckForDebuggerJustMyCode
	npad	1
...
; 14   :     std::cout << "\nHospital Reservation system initializing ...\n\n";
	...
	lea	rdx, OFFSET FLAT:??_C@_0DA@BNIHJLDD@?6Hospital?5Reservation?5system?5in@
